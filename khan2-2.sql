CREATE SEQUENCE tmp_seq START WITH 0 INCREMENT BY 1 MAXVALUE 100 CYCLE NOCACHE;
CREATE SEQUENCE tmp_seq2 START WITH 0 INCREMENT BY 1 MAXVALUE 100 CYCLE NOCACHE;
